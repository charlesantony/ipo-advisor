        ...
        for r in records:
            conn.execute(
                ...
                ON CONFLICT(tracker_key) DO UPDATE SET
                    ...
                    issue_price=excluded.issue_price,
                    total_x=excluded.total_x,
                    gmp_used_pct=COALESCE(excluded.gmp_used_pct, year_model_tracker.gmp_used_pct),
                    gmp_used_rupees=COALESCE(excluded.gmp_used_rupees, year_model_tracker.gmp_used_rupees),
                    gmp_used_at_ist=COALESCE(excluded.gmp_used_at_ist, year_model_tracker.gmp_used_at_ist),
                    gmp_quality=COALESCE(excluded.gmp_quality, year_model_tracker.gmp_quality),
